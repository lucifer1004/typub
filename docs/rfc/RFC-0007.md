...
<!-- SIGNATURE: sha256:215021d0378f10e798119c459aa0c2846c62fa947d80e6e604d14821aea037f8 -->
...
**References:**
- [RFC-0006](../rfc/RFC-0006.md) — adapter extension API (defines `AdapterRegistrar`, `External` variant)
- [ADR-0002](../adr/ADR-0002.md) — shared types in `typub-core`
- [ADR-0003](../adr/ADR-0003.md) — extraction of `typub-html` subcrate
